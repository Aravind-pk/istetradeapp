            ...
            <div id="login">
                ...
                <div className="lg:flex">
                        ...
                        <div className="py-12 bg-indigo-100 lg:bg-white flex justify-center lg:justify-start lg:px-12">
                            ...
                            <div className="text-2xl text-indigo-800 tracking-wide ml-2 font-semibold">Trado Mania</div>
                            </div>
                        </div>
                        <div className="mt-10 px-12 sm:px-24 md:px-48 lg:px-12 lg:mt-16 xl:px-24 xl:max-w-2xl">
                            ...
                            <form  onSubmit={this.handleSubmit} >
                                ...
                                <input className="w-full text-lg py-2 border-b border-gray-300 focus:outline-none focus:border-indigo-500"  placeholder="mike@gmail.com" type="email" name="email" onChange={this.handleChange} value={this.state.email} required/>
                                </div>
                                <div className="mt-8">
                                ...
                                <input className="w-full text-lg py-2 border-b border-gray-300 focus:outline-none focus:border-indigo-500" placeholder="Enter your password"  type="password" name="password" onChange={this.handleChange} value={this.state.password} required/>
                                </div>
                                <div className="mt-5 text-sm font-display font-semibold text-red-700 text-center">
                                    {this.state.error}
                                </div>
                                <div className="mt-8">
                                {this.state.loading ? <button className="bg-indigo-500 text-gray-100 p-4 w-full rounded-full tracking-wide
                                                font-semibold font-display focus:outline-none focus:shadow-outline hover:bg-indigo-600
                                                shadow-lg" >Loading..</button> : <button className="bg-indigo-500 text-gray-100 p-4 w-full rounded-full tracking-wide
                                                font-semibold font-display focus:outline-none focus:shadow-outline hover:bg-indigo-600
                                                shadow-lg">Log In</button>}
                                </div>
                            </form>

                            {/* form ends */}
                            <div className="mt-8 text-sm font-display font-semibold text-gray-700 text-center">
                                Athena <p className="cursor-pointer text-indigo-600 hover:text-indigo-800">ISTE TKMCE</p>
                            </div>
                            </div>
                        </div>
                        </div>
